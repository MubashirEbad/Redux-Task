...
class MainPage extends React.Component {
    ...
    onChange = debounce(async (text = '') => {
        if (text !== '') {
            this.props.store.dispatch(updateLoadingIconStatus(true, types.LOADING_ICON_STATUS));
            await this.props.store.dispatch(fetchDataFromAPI(text, types.LOAD_BOOKS_DATA_SUCCESS));
